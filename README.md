...
src/
  ...
  world/
    ...
    ground.js / textures.js # terrain material + baked textures + procedural fallback
...
- Plain JS + WebAudio, build-time generated tileable textures, and procedural world/audio systems.
- Material textures are generated by `scripts/generate-textures.mjs` and cached by the PWA;
  Canvas generation remains as a development/missing-asset fallback.
